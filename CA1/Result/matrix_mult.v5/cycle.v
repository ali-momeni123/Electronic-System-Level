...
//  Generated date: Fri Mar 29 21:12:19 2024
// ----------------------------------------------------------------------
...
module matrix_mult_core (
  ...
  always begin : core
                ...
                begin : loop3Exit
                  forever begin : loop3
                    ...
                    if ( loop3_stage_0_1 ) begin
                      ...
                      exit_loop3 = ~ (readslicef_3_1_2((({1'b1 , (loop3_k_1_sva_1[3:2])})
                          + 3'b1)));
                      loop3_asn_9_itm = exit_loop3;
                      if ( exit_loop3 ) begin
                        loop3_stage_0 = 1'b0;
                      end
                      else begin
                    ...
                    if ( ~(loop3_stage_0 | loop3_stage_0_1) )
                      disable loop3Exit;
                    loop3_asn_9_itm_1 = loop3_asn_9_itm;
                    loop3_stage_0_2 = loop3_stage_0_1;
                    loop3_stage_0_1 = loop3_stage_0;
                  end
                end
    ...
    loop3_asn_9_itm = 1'b0;
    loop2_partial_out_sva_1 = 32'b0;
