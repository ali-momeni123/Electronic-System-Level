...
//  Generated date: Fri Mar 29 21:16:01 2024
// ----------------------------------------------------------------------
...
module matrix_mult_core (
  ...
  always begin : core
    ...
    reg exit_loop2_lpi_2_dfm;
    reg [31:0] loop2_partial_out_sva_dfm;
    reg [3:0] loop3_k_1_sva_dfm;
    reg [3:0] loop1_i_1_sva_1;
    reg loop2_stage_0;
    reg exit_loop3_sva_1;
    reg exit_loop2_lpi_2_dfm_1;
    reg exit_loop3_sva_st;
    reg exit_loop2_lpi_2_dfm_st;
    reg loop2_asn_8_itm;
    reg exit_loop3_sva_st_1;
    reg exit_loop2_lpi_2_dfm_st_1;
            ...
            begin : loop2Exit
              forever begin : loop2
                ...
                if ( loop2_stage_0_2 ) begin
                  ...
                  if ( exit_loop2_lpi_2_dfm_st_1 ) begin
                  end
                  else begin
                    loop2_partial_out_sva_dfm = loop2_partial_out_sva_1 & (signext_32_1(~
                        exit_loop3_sva_1));
                  end
                  if ( loop2_asn_8_itm_1 ) begin
                  end
                  else begin
                    loop2_partial_out_sva = MUX_v_32_2_2({loop2_partial_out_sva_dfm
                        , loop2_partial_out_sva_1}, exit_loop2_lpi_2_dfm_1);
                  end
                end
                if ( loop2_stage_0_1 ) begin
                  loop3_k_1_sva_dfm = 4'b0;
                  exit_loop2_sva_1 = 1'b0;
                  loop2_j_1_sva_1 = 4'b0;
                  ...
                  exit_loop2_lpi_2_dfm = exit_loop2_sva_1 & exit_loop3_sva;
                  exit_loop2_lpi_2_dfm_st = exit_loop2_lpi_2_dfm;
                  if ( exit_loop2_lpi_2_dfm ) begin
                  end
                  else begin
                    loop3_k_1_sva_dfm = loop3_k_1_sva_1 & (signext_4_1(~ exit_loop3_sva));
                  end
                  loop2_asn_8_itm = exit_loop2_lpi_2_dfm;
                  if ( exit_loop2_lpi_2_dfm ) begin
                    loop2_stage_0 = 1'b0;
                  end
                  else begin
                    loop2_j_1_sva = MUX_v_4_2_2({loop2_j_1_sva , loop2_j_1_sva_1},
                        exit_loop3_sva);
                    loop3_k_1_sva = loop3_k_1_sva_dfm;
                  end
                end
                if ( ~(loop2_stage_0 | loop2_stage_0_1 | loop2_stage_0_2) )
                  disable loop2Exit;
                exit_loop3_sva_1 = exit_loop3_sva;
                exit_loop2_lpi_2_dfm_1 = exit_loop2_lpi_2_dfm;
                loop2_acc_3_itm_3 = loop2_acc_3_itm_2;
                loop2_acc_3_itm_1_sg1 = loop2_acc_3_itm_sg1;
                exit_loop3_sva_st_1 = exit_loop3_sva_st;
                exit_loop2_lpi_2_dfm_st_1 = exit_loop2_lpi_2_dfm_st;
                loop2_asn_8_itm_1 = loop2_asn_8_itm;
                loop2_stage_0_2 = loop2_stage_0_1;
                loop2_stage_0_1 = loop2_stage_0;
              end
            end
            input_matrix1_rsc_REGISTER_FILE_addr_rd_reg_1 <= 2'b0;
            input_matrix1_rsc_REGISTER_FILE_addr_rd_reg_sg1 <= 5'b0;
    ...
    exit_loop2_lpi_2_dfm_st_1 = 1'b0;
    exit_loop3_sva_st_1 = 1'b0;
    loop2_asn_8_itm = 1'b0;
    exit_loop2_lpi_2_dfm_st = 1'b0;
    exit_loop3_sva_st = 1'b0;
    exit_loop2_lpi_2_dfm_1 = 1'b0;
    exit_loop3_sva_1 = 1'b0;
    exit_loop2_lpi_2_dfm = 1'b0;
    exit_loop3_sva = 1'b0;
